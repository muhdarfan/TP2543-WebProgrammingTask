...
<head>
    ...
    <title>EagleZ Inventory System : Orders Details</title>
    <!-- Bootstrap -->
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form-horizontal" name="frmorder" id="forder"
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        ...
                        <button class="btn btn-default" type="submit" name="addproduct"><span
                                    class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product
                        </button>
