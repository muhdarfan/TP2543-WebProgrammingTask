        ...
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="customerid" placeholder="Customer ID"
                               value="<?php echo(isset($_GET['edit']) ? $fID : $NextID); ?>" readonly
                               required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="name" type="text" class="form-control" id="fullname"
                               ...
                               value="<?php if (isset($_GET['edit'])) echo $editrow['FLD_CUSTOMER_NAME']; ?>"
                               required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="address" type="text" class="form-control" id="address" placeholder="Address"
                                  rows="5" style="resize:none;"
                                  required><?php if (isset($_GET['edit'])) echo $editrow['FLD_CUSTOMER_ADDRESS']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="phone" type="text" class="form-control" id="phone"
                               ...
                               value="<?php if (isset($_GET['edit'])) echo $editrow['FLD_CUSTOMER_PHONE']; ?>"
                               required/>
                    </div>
                </div>
                    ...
                    <div class="col-sm-offset-3 col-sm-9">
                        <?php if (isset($_GET['edit'])) { ?>
                            <input type="hidden" name="oldcid"
                                   value="<?php echo $editrow['FLD_CUSTOMER_ID']; ?>">
                ...
                foreach ($result as $readrow) {
                    ...
                    <tr style="color: #AAA;">
                        ...
                        <td class="text-center">
                            ...
                            if (isset($_SESSION['user']) && $_SESSION['user']['FLD_STAFF_ROLE'] == 'admin') {
                                ?>
                                <a href="customers.php?edit=<?php echo $readrow['FLD_CUSTOMER_ID']; ?>"
