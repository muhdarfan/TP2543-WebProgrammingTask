...
if (isset($_POST['create'])) {
  try {
    $stmt = $conn->prepare("INSERT INTO tbl_staffs_a174652_pt2(FLD_STAFF_NAME, 
      FLD_STAFF_GENDER, FLD_STAFF_PHONE) VALUES(:name, :gender, :phone)");
...
if (isset($_POST['update'])) {
  try {
    $stmt = $conn->prepare("UPDATE tbl_staffs_a174652_pt2 SET FLD_STAFF_NAME = :name, FLD_STAFF_GENDER = :gender, FLD_STAFF_PHONE = :phone WHERE FLD_STAFF_ID = :oldsid");
